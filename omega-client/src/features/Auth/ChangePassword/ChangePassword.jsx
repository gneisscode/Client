    ...
    <div className="flex flex-col items-center gap-4 p-10">
      ...
      <div>
        <Card className="p-14 flex flex-col items-center gap-10 "> 
          <input className="border border-blue-600 w-[589px] h-[61px] p-6" placeholder="New Password:"/>
          <input className="border border-blue-600 w-[589px] h-[61px] p-6 mb-16" placeholder="Confirm New Password:"/>

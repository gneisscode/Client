        ...
        <div className="px-6 py-10 w-[982px] absolute top-[112px] left-[300px]">
          ...
          <div>
            ...
            <form className="grid grid-cols-2 gap-8 mb-16">
              <input
                className="border w-4/5 p-2 rounded bg-[#FAFCFF] border-[#a09b9b] outline-none"
                type="text"
          ...
          <div>
            ...
            <p className="text-center mt-6 font-semibold text-[#616060]">
              Upload an image to use as profile picture
            </p>
            <p className="text-center text-[#616060]">
              <i>Compatible file type: .jpg, .png, .svg, .bmp or .dxf</i>
            </p>
          </div>
          <div className="flex flex-col">
            <button className="mt-12 bg-blue-500 text-white w-[250px] mx-auto p-2 rounded">
              Upload Image
            </button>
            <button className="mt-32 bg-blue-500 text-white w-[150px] ml-auto mr-8 p-2 rounded">
              Save
            </button>
          </div>
        </div>

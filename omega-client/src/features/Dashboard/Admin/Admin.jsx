    ...
    <div className="flex flex-col">
      ...
      <div className="flex ">
        ...
        <div className='py-10 px-10 w-full'>
          <h4 className='text-blue-500 font-semibold text-xl'>Admin Dashboard</h4>
          <div className='grid grid-cols-2 mt-3'>
            <h3 className='text-green-500 font-semibold'>Number of Admins (6)</h3>
            <button className='justify-self-end bg-blue-500 px-3 pb-1 text-white rounded text-lg'><span className='text-2xl'>{'\u002B'}</span> Add Admin</button>
          </div>
          <div className='grid grid-cols-3 gap-4 mt-10'>
            <div className='px-8 py-6 border-blue-500 border rounded-md bg-[#f4f7fc]'>
              <div className='flex flex-row gap-10'>
                <img src="assets/dashboard/admin1.png" alt='admin-img' className='w-[60px] h-[60px]'/>
                <div className=''>
            ...
            <div className='px-8 py-6 border-green-500 border rounded-md bg-[#f4f7fc]'>
              <div className='flex flex-row gap-10'>
                <img src="assets/dashboard/admin2.png" alt='admin-img' className='w-[60px] h-[60px]'/>
                <div className=''>
            ...
            <div className='px-8 py-6 border-red-400 border rounded-md bg-[#f4f7fc]'>
              <div className='flex flex-row gap-10'>
                <img src="assets/dashboard/admin3.png" alt='admin-img' className='w-[60px] h-[60px]'/>
                <div className=''>
            ...
            <div className='px-8 py-6 border-red-400 border rounded-md bg-[#f4f7fc]'>
              <div className='flex flex-row gap-10'>
                <img src="assets/dashboard/admin4.png" alt='admin-img' className='w-[60px] h-[60px]'/>
                <div className=''>
            ...
            <div className='px-8 py-6 border-blue-500 border rounded-md bg-[#f4f7fc]'>
              <div className='flex flex-row gap-10'>
                <img src="assets/dashboard/admin5.png" alt='admin-img' className='w-[60px] h-[60px]'/>
                <div className=''>
            ...
            <div className='px-8 py-6 border-green-500 border rounded-md bg-[#f4f7fc]'>
              <div className='flex flex-row gap-10'>
                <img src="assets/dashboard/admin6.png" alt='admin-img' className='w-[60px] h-[60px]'/>
                <div className=''>

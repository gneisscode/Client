      ...
      <div className="flex ">
        ...
        <div className="lg:w-[938px] lg:h-[fit] bg-[#FAFCFF] border border-[#CCE1FF] ml-[44px] mt-[128px] mb-16">
          ...
          <div className="mt-5 p-5">
            <p className="font-[600] text-[20px] text-[#013E99]  ">Loans Declined</p>
            <p className="font-[500] text-[16px] text-[#FF2727] mt-5">Total Amount: 4,587,541.28</p>
            <p className="font-[700] text-[14px] text-[#0252CC] mt-5">Last Month</p>
          </div>
              ...
              <tbody>
                {repeatData.map((row, index) => (
                  <tr key={index} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                    <td className="px-6 py-4 font-[600] text-[16px]text-[#666666]">{row.name}</td>
                    <td className="px-6 py-4 font-[600] text-[16px]text-[#666666]">{row.date}</td>
                    <td className="px-6 py-4 font-[600] text-[16px]text-[#666666]">
                      <span className={`text-[#FF2727]`}>{row.status}</span>
                    </td>
                    <td className="px-6 py-4 font-[600] text-[16px]text-[#666666]">{row.creditScore}</td>
                    <td className="px-6 py-4 font-[600] text-[16px]text-[#666666]">{row.amount}</td>
                  </tr>
                ))}
              </tbody>
            </table>

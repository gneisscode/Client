  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex relative ">
        <Sidebar />
        <div className="flex flex-col pl-8 pt-[160px]  w-[982px] pr-2 gap-8 absolute top-[112px] left-[300px]">
          ...
          <div className="flex flex-col mt-10">
            <button className="border-blue-600 border-solid text-white border text-sm rounded w-2/5 py-2 bg-blue-600">
              Cancel Loan Generation
            </button>
            <button className=" text-blue-600 text-sm w-2/5 py-2 mb-8">
